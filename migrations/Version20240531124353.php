 ...
 */
final class Version20240531124353 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', paid TINYINT(1) NOT NULL, reference VARCHAR(255) NOT NULL, shipping_fees DOUBLE PRECISION NOT NULL, products_price DOUBLE PRECISION NOT NULL, total_to_pay DOUBLE PRECISION NOT NULL, tracking LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
