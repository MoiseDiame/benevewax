 ...
 */
final class Version20240130212904 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_size (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE adult_shoes_size ADD product_size_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE adult_shoes_size ADD CONSTRAINT FK_4EAE4A569854B397 FOREIGN KEY (product_size_id) REFERENCES product_size (id)');
        ...
        $this->addSql('ALTER TABLE adult_veste_size ADD CONSTRAINT FK_66FA34DD9854B397 FOREIGN KEY (product_size_id) REFERENCES product_size (id)');
        ...
        $this->addSql('ALTER TABLE kids_shoe_size ADD CONSTRAINT FK_1C93E6629854B397 FOREIGN KEY (product_size_id) REFERENCES product_size (id)');
        ...
        $this->addSql('ALTER TABLE kids_veste_size ADD CONSTRAINT FK_FCEF34479854B397 FOREIGN KEY (product_size_id) REFERENCES product_size (id)');
